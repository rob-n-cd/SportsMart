            ...
            foreach($values as $key=>$val)
            {
               ...
               // validate image array
                ...
                if($flag==1)
                {
                    if(isset($config['images']) && isset($config['images']['field']) && $key==$config['images']['field'])
                    {
                        ...
                        {   
                            if(!in_array($key,$config['hiddenfields']))
                            {
                                $str.="<td style = 'border:1px solid black';><img src='".$config['images']['path'].$val."' ";
                ...
                {   
                    if(!in_array($key,$config['hiddenfields']))
                    {
                        $str.="<td style='font-size:20px;border:1px solid black';>".$val."</td>";
                    ...
                    $str.="<td style='font-size:20px;'>".$val."</td>";
