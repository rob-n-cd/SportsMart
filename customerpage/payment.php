...
?>         
  ...
  <div id="payment-ground" style="display: block; justify-content:center; margin-left:33vh; align-items:center; position:fixed;  background:rgba(255, 0, 0, 0);  width:163vh; height:100vh; border-radius:9px;">
    <div style=" justify-content:center; margin-left:10vh; align-items:center; position:fixed;  background:rgb(62, 68, 63); margin-top:3vh;  width:150vh; height:94vh; border-radius:9px;">
      <h1 style="color: cornsilk; text-align:center; font-family:cursive">Payment Page</h1>
      <img src="/SportsMart/upload/<?php echo $pay_row['image'];?>" style="width: 30vh; height:40vh; border-radius:6px; margin-left:calc(4%); margin-top:calc(7%)"/>
...
.dropdown-content a:hover {background-color: #ddd;}
    ...
    .editprofileground{width: 190vh; height: 100vh; background: transparent; display: none; position: fixed;}
      ...
      .cross{ display:flex;  justify-content:center;  color:rgb(0, 0, 0); background:rgb(235, 4, 4); position:fixed; margin-left:189vh; margin-top:-92vh; height: 3vh;padding-bottom:5vh; padding-right:8px; padding-left:8px; border-radius:50px; font-size:25px; height:1px; width: 35px;}
