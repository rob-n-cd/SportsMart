        ...
        <div class="content-wrapper">
          ...
          <div class="row mt-3">
            <div class="col-xl-3 flex-column d-flex grid-margin stretch-card">
              <div class="row flex-grow">
                ...
                <div class="col-sm-12 stretch-card">
                    <div class="card" style="border: 2px solid rgb(50, 4, 106);">
                      <div class="card-body">
                          <h4 class="card-title"> Total Categorys</h4>
                          <p>6% decrease in earnings</p>
                          <h4 class="text-dark font-weight-bold mb-2"><?php echo $table3->num_rows; ?> Records</h4>
            ...
            <div class="col-xl-9 d-flex grid-margin stretch-card">
                <div class="card"  style="border: 3px solid rgb(65, 102, 46);">
                  <div class="card-body">
