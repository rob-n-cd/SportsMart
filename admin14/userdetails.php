...
<body>
  <div class="container-scroller">
    ...
    <div class="container">
    	<div class="row">
            <div class="col-md-12">
                <table  border="1" class="table badge-light thead-dark" style="margin-top:100px; font-size:3vh;">
   ...
   $join=array(
     ...
     $fields=array('id','username','name','email','address','phonenumber','gender');

    $users=$dao->selectAsTable($fields,'register',"status=1",null);
